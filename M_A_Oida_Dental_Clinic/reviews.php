  ...
  while ($row = $res->fetch_assoc()) {
    ...
    $out[] = [
      ...
      'profile_picture'=> $isAnonymous
                            ? 'assets/photos/profile_icon.png'
                            : 'uploads/profiles/' . ($row['profile_picture'] ?? 'profile_icon.png')
    ];
  }
    ...
    <div class="nav-right">
      ...
      <a href="<?= $user ? 'profile.php' : 'login.php' ?>"
        ...
        <div class="user-icon">
          ...
          <?php else: ?>
            <img src="assets/photos/profile_icon.png" alt="Profile" class="profile-pic">
          <?php endif; ?>
        </div>
      </a>
    </div>
...
<div id="reviewModal" class="modal">
  <div class="modal-content review-modal">
    ...
    <div class="modal-header">
      <img src="assets/photos/profile_icon.png" class="modal-avatar">
