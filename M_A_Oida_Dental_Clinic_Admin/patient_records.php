...
<body class="bg-white text-gray-900">
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="flex flex-col bg-white border-r border-gray-200 w-64 min-w-[256px] py-6 px-4">
            <!-- Same sidebar as appointments.php but with patient_records.php highlighted -->
            ...
            <nav class="flex flex-col space-y-2 text-gray-700 text-sm font-medium">
                ...
                <a class="flex items-center space-x-3 px-3 py-2 rounded-lg bg-blue-100 text-blue-900" href="patient_records.php">
                    <div class="flex items-center justify-center w-8 h-8 bg-gray-200 rounded-lg text-gray-700">
            ...
            <div class="flex-1 p-6 overflow-y-auto space-y-6">
                ...
                <section class="bg-white rounded-lg border border-gray-300 shadow-md p-4">
                    <div class="flex justify-between items-center mb-3">
                        ...
                        <div class="relative">
                            <input aria-label="Search" class="border border-gray-400 rounded text-sm pl-7 pr-2 py-1 focus:outline-none focus:ring-1 focus:ring-blue-600" placeholder="Search patients..." type="text"/>
                            ...
                            <tbody>
                                <tr class="border-t border-gray-400">
                                    ...
                                    <td class="px-2 py-1 whitespace-nowrap flex items-center space-x-2">
                                        ...
                                        <button class="bg-green-700 text-white text-xs font-semibold rounded px-3 py-1" type="button">
                                            Edit
                                        </button>
                                    </td>
                                </tr>
